...
<!--          </div>-->
          <el-table :data="tableData"
                    ...
                    border
          >
            <el-table-column prop="vipId" label="会员编号" width="150px">
            </el-table-column>
            <el-table-column prop="userId" label="用户账号" width="150px">
            </el-table-column>
            <el-table-column prop="level" label="会员等级" width="150px">
            </el-table-column>
            <el-table-column prop="credit" label="会员积分" width="150px">
            </el-table-column>
            <el-table-column prop="startTime" label="缴费时间" width="225px">
            </el-table-column>
            <el-table-column prop="endTime" label="到期时间" width="225px">
            </el-table-column>
            <el-table-column prop="remainingAmountt" label="会员余额" width="225px">
            </el-table-column>
<!--             <el-table-column  width="80px" label="注册时长">-->
<!--               <input type="text"  style="width:54px" v-model="input">-->
<!--            </el-table-column>-->
<!--             <el-table-column  width="80px" label="充值金额">-->
